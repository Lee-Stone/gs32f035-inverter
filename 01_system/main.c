/*
 * 01_system/main.c -> GS32F035P Port (Phase 1)
 * TI original: Main entry point with time-sliced control loop.
 * GS32: Entry point is src/main.c. Original TI code in #if 0 below.
 */
