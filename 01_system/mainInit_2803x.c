...
void InitSetAdc(void)
{
    ...
    // SOC通道配置：ePWM1 ADCSOCA触发，采样窗8个ADC周期
    // TI ADCINA0~7 → GS32 ADC_CH_ADCIN0~7 (ADCA)
    // TI ADCINB0~7 → GS32 ADC_CH_ADCIN8~15 (ADCC)
#if (SOFTSERIES == MD380SOFT)
    ADC_setupSOC(ADCC_BASE, ADC_SOC_NUMBER0,  ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN7, 8); // ADCINB7-GND
    ...
    ADC_setupSOC(ADCC_BASE, ADC_SOC_NUMBER4,  ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN1, 8); // ADCINB1-TEMP
    ADC_setupSOC(ADCC_BASE, ADC_SOC_NUMBER5,  ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN0, 8); // ADCINB0-IV
...
#else
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER0,  ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN2,  8); // ADCINA2-IB (第1个通道不用)
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER1,  ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN0,  8); // ADCINA0-IU
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER2,  ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN3,  8); // ADCINA3-IW
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER3,  ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN5,  8); // ADCINA5-UDC
